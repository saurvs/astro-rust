...
**/
pub fn compan_mean_annual_motion(period_rev: f64) -> f64 {
...
**/
pub fn compan_mean_anomaly(mean_annual_motion: f64, periastron_pass: f64, time: f64) -> f64 {
...
**/
pub fn appar_pos_angle(asc_node_pos: f64, true_anomaly: f64, periastron_long: f64, inc: f64) -> f64 {
...
* ```periastron_long```: Longitude of periastron
**/
pub fn eccent_of_appar_orbit(ecc_true_orb: f64, true_anomaly: f64, periastron_long: f64, inc: f64) -> f64 {
