...
/**
Computes the **true anomaly** and **radius vector** *(AU)* of a body in a parabolic orbit
...
**/
pub fn Position(obl_eclp: f64, long_asc_node: f64, inc: f64, perih_arg: f64, time_passg_perih: f64, t: f64, perih_dist: f64) -> (f64, f64) {
