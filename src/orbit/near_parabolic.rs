...
/**
Returns the true anomaly and radius vector of a body in a near-parabolic
orbit
...
* `accuracy`: Desired accuracy for the results. Eg: 0.000001 gives that
              much accuracy in radians and AU.
**/
pub fn true_anom_and_rad_vec(
    t: f64,
    T: f64,
    ecc: f64,
    q: f64,
    accuracy: f64) -> (f64, f64) {
